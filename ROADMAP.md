...
- **Exercises/project:** supervised baseline, metric selection, error analysis, model comparison.
...
- **Exercises/project:** train a small model, inspect gradients, diagnose under/overfitting.
...
- **Exercises/project:** build a minimal provider-neutral LLM service and decoding benchmark.
...
- **Exercises/project:** evaluation platform with dataset versioning, judge calibration, regression gates.
...
- **Exercises/project:** `projects/rag-platform`; follow the 10-step exercise ladder in `exercises/06-rag/`.
...
- **Exercises/project:** graph augmentation and query router with controlled fallback.
...
- **Exercises/project:** `projects/llm-gateway`, semantic cache, cost router, feature rollout.
...
- **Exercises/project:** deterministic workflow first, then agent orchestration with human-in-the-loop.
...
- **Exercises/project:** fine-tuning pipeline with controlled dataset and holdout evaluation.
...
- **Exercises/project:** compare optimization strategies under a fixed quality floor.
...
- **Exercises/project:** red-team corpus and layered defenses with regression tests.
...
- **Project:** `projects/capstone/`; build only after component evidence exists.
